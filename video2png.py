...
def extract_sheet_music_frames(video_path, output_dir='output_frames', interval_seconds=9):
    """
    ...
    print(f"Saving one frame every {interval_seconds} seconds (every {frame_interval} frames)")
...
if __name__ == "__main__":
    ...
    video_path = './In the pool | Piano.webm'
